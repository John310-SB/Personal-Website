...
function About() {
            ...
            <Timeline position="alternate">
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>1997 to Present</div>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
                        <TimelineDot />
                        <TimelineConnector />
                    </TimelineSeparator>
                    <TimelineContent><div className='TimelineContent'>I grew up in Hermosa Beach, California.</div></TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>Graduated in 2015</div>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
                        <TimelineDot />
                        <TimelineConnector />
                    </TimelineSeparator>
                    <TimelineContent><div className='TimelineContent'>Attended Mira Costa Highschool.</div></TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>2015 to 2020</div>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
                        <TimelineDot />
                        <TimelineConnector />
                    </TimelineSeparator>
                    <TimelineContent><div className='TimelineContent'>Joined the Electrical Union for Commercial Electrical.</div></TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>2020 to Present</div>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
                        <TimelineDot />
                        <TimelineConnector />
                    </TimelineSeparator>
                    <TimelineContent><div className='TimelineContent'>Started a business called Card Realm LLC, a trading card marketplace. </div></TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>Card Realm Launched in May of 2022</div>
                    </TimelineOppositeContent>
                    <TimelineSeparator>
                        <TimelineDot />
                        <TimelineConnector />
                    </TimelineSeparator>
                    <TimelineContent><div className='TimelineContent'>Built and Launched Card Realm on the App Store and Play Store. </div></TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    <TimelineOppositeContent>
                        <div className='TimelineContentDate'>2020 to Present</div>
                    ...
                    <TimelineContent><div className='TimelineContent'>Joined Formation Fellowship to solidify CS fundamentals and learned from mentors from top companies.</div></TimelineContent>
                </TimelineItem>
            </Timeline>
    ...
    const [q1, setQ1] = useState("questionSelect borderRight noSelect");
    ...
    function animate() {
        console.log(redVal);
        if (redVal) {
            setTimeout(() => { changeStyles(2); setAnswer(answer2); animate3() }, 14000)
            clearTimeout();
        }
        return
    }
    ...
    function animate3() {
        console.log(redVal, "second animation");
        if (redVal) {
            setTimeout(() => { changeStyles(3); setAnswer(answer3); animate4(); }, 50000);
            clearTimeout();
        }
        return
    }
    ...
    function animate4() {
        console.log(redVal, "third animation");
        if (redVal) {
            setTimeout(() => { changeStyles(4); setAnswer(answer4); animate5(); }, 14000);
            clearTimeout();
        }
        return
    }
    ...
    function animate5() {
        console.log(redVal, "4th animation");
        if (redVal) {
            setTimeout(() => { changeStyles(5); setAnswer(answer5); animate6(); }, 18000);
            clearTimeout();
        }
        return
    }
    ...
    function animate6() {
        if (redVal) {
            setTimeout(() => { navigate('/projects', { replace: true }); }, 18000);
            clearTimeout();
        }
        return
    }

    //Changes Styles for Questions
